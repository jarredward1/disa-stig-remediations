...
A growing collection of standalone PowerShell scripts that automatically detect and remediate DISA STIG (Security Technical Implementation Guide) findings on **Windows 11** endpoints — each one self-contained, self-verifying, and built for real-world ops.
...
|---|---|---|
| `WN11-00-000150` | General | Enables SEHOP — Structured Exception Handling Overwrite Protection |
| `WN11-CC-000150` | Component Config | Requires password on resume from sleep (AC/plugged-in) |
| `WN11-SO-000265` | Security Options | Restricts UAC elevation to apps installed in secure locations only |
